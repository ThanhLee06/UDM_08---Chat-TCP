...
public class ChatController {
    ...
    private vn.edu.ut.udm08.client.network.ChatClient chatClient;
    ...
    public void setChatClient(vn.edu.ut.udm08.client.network.ChatClient chatClient) {
        this.chatClient = chatClient;
        setSendListener(new MessageSendListener() {
            @Override
            public void onSendMessage(ProtocolMessage message) {
                try {
                    chatClient.sendMessage(message.target, message.content);
                } catch (Exception e) {
                }
            }
        });
